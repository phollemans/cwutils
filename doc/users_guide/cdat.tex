...
\noindent\fbox{%
    \parbox{\textwidth}{%
This section contains out of date diagrams from version 3.8.0.  Many parts
of the software are similar enough that these descriptions can still be useful.
This section will be updated in a future verion of this guide.
    }%
}
...
\item[Windows Vista/7/10] -- \verb+\Users\[User name]\AppData\Roaming\CoastWatch+
