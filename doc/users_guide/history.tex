...
\begin{itemize}
    ...
    is also available to run scripts that create GUI windows.
...
\begin{itemize}
  ...
  \item In some cases, coastlines plotted on images in CDAT and cwrender
  looked low-resolution.  This has been corrected by adding a new higher
  resolution coastline database, and adjusting the algorithm that selects
  the coastline detail level to use for a scene being displayed.
...
\begin{itemize}
  ...
  font and a -{-}font-list option to list system-specific fonts available.
