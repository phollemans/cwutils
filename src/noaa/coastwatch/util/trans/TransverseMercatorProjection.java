////////////////////////////////////////////////////////////////////////
/*
     FILE: TransverseMercatorProjection.java
  PURPOSE: Handles Transverse Mercator map transformations.
...
/**
 * The <code>TransverseMercatorProjection</code> class performs 
...
public class TransverseMercatorProjection 
  ...
  public TransverseMercatorProjection (
    ...
    // Initialize
    // ----------
    super (TM, 0, rMajor, rMinor, dimensions, affine);
    setFalse (falseEast, falseNorth);
    long result = projinit (rMajor, rMinor, scale_fact, center_lon, center_lat, 
      falseEast, falseNorth);
    if (result != OK) 
      throw new IllegalArgumentException ("Projection parameter inconsistency detected");

  } // TransverseMercatorProjection constructor
